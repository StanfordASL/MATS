...
class DiscreteLatent(object):
    def __init__(self, hyperparams, device):
        ...
        self.device = device
        self.temp = None  # filled in by ASubmodel.set_annealing_params
        self.z_logit_clip = None  # filled in by ASubmodel.set_annealing_params
        self.p_dist = None  # filled in by ASubmodel.encoder
        self.q_dist = None  # filled in by ASubmodel.encoder
    ...
    def kl_q_p(self, log_writer=None, prefix=None, curr_iter=None):
        ...
        #
        # return kl
        return td.kl_divergence(self.q_dist, self.p_dist)
