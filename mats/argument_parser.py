...
parser.add_argument('--no_robot_node',
...
parser.add_argument('--no_B',
                    help="If specified, do not use B",
                    action='store_true')

parser.add_argument('--reg_B',
                    help="If specified, include a penalty on B's 1-norm",
                    action='store_true')

parser.add_argument('--zero_R_rows',
                    help="If specified, the robot's non-diagonal rows in A will be zero",
                    action='store_true')

parser.add_argument('--reg_A_slew',
                    help="If specified, include a penalty on A's slew rate (L1 norm between timesteps)",
                    action='store_true')

parser.add_argument('--reg_B_weight',
                    help="The weight of the penalty on B's nuclear norm",
                    type=float,
                    default=1.0)

parser.add_argument('--reg_A_slew_weight',
                    help="The weight of the penalty on A's slew rate",
                    type=float,
                    default=1.0)
...
parser.add_argument("--batch_multiplier",
                    help="number of batches with which to effectively backpropagate",
                    type=int,
                    default=16)
